...
POLICY_TEMPLATE: dict[str, Any] = {
    ...
    "require_resolved_candidate_objective": True,
    "require_train_sequence_target_scales": True,
    "require_no_negative_rv_predictions": True,
    "require_loss_balance_freeze": True,
    "require_balance_before_validation": True,
    "balance_freeze_overwrite_allowed": False,
